...
class JunoLab(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def get_patch_sysex_data(self):
        data = []
        if self.dco_env_mode_env_rbutton.isChecked():
            data.append(0)
        elif self.dco_env_mode_inv_rbutton.isChecked():
            data.append(1)
        elif self.dco_env_mode_denv_rbutton.isChecked():
            data.append(2)
        else:
            data.append(3)
        if self.vcf_env_mode_env_rbutton.isChecked():
            data.append(0)
        elif self.vcf_env_mode_inv_rbutton.isChecked():
            data.append(1)
        elif self.vcf_env_mode_denv_rbutton.isChecked():
            data.append(2)
        else:
            data.append(3)
        if self.vca_env_mode_env_rbutton.isChecked():
            data.append(0)
        elif self.vca_env_mode_gt_rbutton.isChecked():
            data.append(1)
        elif self.vca_env_mode_denv_rbutton.isChecked():
            data.append(2)
        else:
            data.append(3)
        if self.dco_pulse_off_rbutton.isChecked():
            data.append(0)
        elif self.dco_pulse_sq_rbutton.isChecked():
            data.append(1)
        elif self.dco_pulse_pw_fix_rbutton.isChecked():
            data.append(2)
        else:
            data.append(3)
        if self.dco_saw_off_rbutton.isChecked():
            data.append(0)
        elif self.dco_saw_saw_rbutton.isChecked():
            data.append(1)
        elif self.dco_saw_pw_fix_rbutton.isChecked():
            data.append(2)
        elif self.dco_saw_pwpwm_rbutton.isChecked():
            data.append(3)
        elif self.dco_saw_saw_alt1_rbutton.isChecked():
            data.append(4)
        else:
            data.append(5)
        if self.dco_sub_sq_rbutton.isChecked():
            data.append(0)
        elif self.dco_sub_pw_fix_rbutton.isChecked():
            data.append(1)
        elif self.dco_sub_sq_alt1_rbutton.isChecked():
            data.append(2)
        elif self.dco_sub_sq_alt2_rbutton.isChecked():
            data.append(3)
        elif self.dco_sub_sub_sq_rbutton.isChecked():
            data.append(4)
        else:
            data.append(5)
        if self.dco_range_4_rbutton.isChecked():
            data.append(0)
        elif self.dco_range_8_rbutton.isChecked():
            data.append(1)
        elif self.dco_range_16_rbutton.isChecked():
            data.append(2)
        else:
            data.append(3)
        ...
        if self.chorus_checkBox.isChecked():
            data.append(1)
        else:
            data.append(0)
    ...
    def set_patch_sysex_data(self, data):
        if data[0] == 0:
            self.dco_env_mode_env_rbutton.setChecked(True)
        elif data[0] == 1:
            self.dco_env_mode_inv_rbutton.setChecked(True)
        elif data[0] == 2:
            self.dco_env_mode_denv_rbutton.setChecked(True)
        elif data[0] == 3:
            self.dco_env_mode_dinv_rbutton.setChecked(True)

        if data[1] == 0:
            self.vcf_env_mode_env_rbutton.setChecked(True)
        elif data[1] == 1:
            self.vcf_env_mode_inv_rbutton.setChecked(True)
        elif data[1] == 2:
            self.vcf_env_mode_denv_rbutton.setChecked(True)
        elif data[1] == 3:
            self.vcf_env_mode_dyn_rbutton.setChecked(True)

        if data[2] == 0:
            self.vca_env_mode_env_rbutton.setChecked(True)
        elif data[2] == 1:
            self.vca_env_mode_gt_rbutton.setChecked(True)
        elif data[2] == 2:
            self.vca_env_mode_denv_rbutton.setChecked(True)
        elif data[2] == 3:
            self.vca_env_mode_dgt_rbutton.setChecked(True)

        if data[3] == 0:
            self.dco_pulse_off_rbutton.setChecked(True)
        elif data[3] == 1:
            self.dco_pulse_sq_rbutton.setChecked(True)
        elif data[3] == 2:
            self.dco_pulse_pw_fix_rbutton.setChecked(True)
        elif data[3] == 3:
            self.dco_pulse_pwpwm_rbutton.setChecked(True)

        if data[4] == 0:
            self.dco_saw_off_rbutton.setChecked(True)
        elif data[4] == 1:
            self.dco_saw_saw_rbutton.setChecked(True)
        elif data[4] == 2:
            self.dco_saw_pw_fix_rbutton.setChecked(True)
        elif data[4] == 3:
            self.dco_saw_pwpwm_rbutton.setChecked(True)
        elif data[4] == 4:
            self.dco_saw_saw_alt1_rbutton.setChecked(True)
        elif data[4] == 5:
            self.dco_saw_saw_alt2_rbutton.setChecked(True)

        if data[5] == 0:
            self.dco_sub_sq_rbutton.setChecked(True)
        elif data[5] == 1:
            self.dco_sub_pw_fix_rbutton.setChecked(True)
        elif data[5] == 2:
            self.dco_sub_sq_alt1_rbutton.setChecked(True)
        elif data[5] == 3:
            self.dco_sub_sq_alt2_rbutton.setChecked(True)
        elif data[5] == 4:
            self.dco_sub_sub_sq_rbutton.setChecked(True)
        elif data[5] == 5:
            self.dco_sub_sub_pw_fix_rbutton.setChecked(True)

        if data[6] == 0:
            self.dco_range_4_rbutton.setChecked(True)
        elif data[6] == 1:
            self.dco_range_8_rbutton.setChecked(True)
        elif data[6] == 2:
            self.dco_range_16_rbutton.setChecked(True)
        elif data[6] == 3:
            self.dco_range_32_rbutton.setChecked(True)
        ...
        if data[10] == 1:
            self.chorus_checkBox.setChecked(True)
        else:
            self.chorus_checkBox.setChecked(False)
